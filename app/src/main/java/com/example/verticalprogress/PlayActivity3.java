...
public class PlayActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //음원
        mp = MediaPlayer.create(PlayActivity3.this, R.raw.youquiz_apartment_mp);
        ...
        try {
            BufferedReader bfRead = new BufferedReader(new InputStreamReader(getResources().openRawResource(R.raw.youquiz_apartment)));
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                //이미지 매핑
                if(Time>=0 && Time<48) {
                    figureImage.setImageResource(R.drawable.apartment1);
                    keyword.setText(" 아파트 외벽 공사 작업자의 밧줄을 끊어 숨지게 한 사건이 기억에 남는다.");
                }else if(Time>=49 && Time<133) {
                    figureImage.setImageResource(R.drawable.apartment2);
                    keyword.setText("경찰이 범행현장에서 증거들을 발견했다.");
                }else if(Time>=134 && Time<243) {
                    figureImage.setImageResource(R.drawable.apartment3);
                    keyword.setText("미세 증거물 중에 로프줄 성분이 나왔다.");
                }else if(Time>=244 && Time<416) {
                    figureImage.setImageResource(R.drawable.apartment4);
                    keyword.setText("절단면을 보면 어떤 도구로 절단을 했는지 알수 있다.");
                }else if(Time>=417 && Time<517) {
                    figureImage.setImageResource(R.drawable.apartment5);
                    keyword.setText("국과수에 오게된 이유");
                }
